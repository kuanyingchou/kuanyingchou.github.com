...
/***/ function(module, exports, __webpack_require__) {
	...
	var m1 = {
	  //layout: 'horizontal',
	  items: [{ name: 'Menu', url: 'home.html', submenu: lm }]
	};

	var m2 = {
	  //layout: 'horizontal',
	  items: [{ name: 'Menu', url: 'home.html', submenu: rm }]
	};

	var m3 = {
	  //layout: 'horizontal',
	  items: [{ name: 'Menu', url: 'home.html', submenu: tm }]
	};

	var m4 = {
	  //layout: 'horizontal',
	  items: [{ name: 'Menu', url: 'home.html', submenu: dm }]
	};

	var m5 = {
	  layout: 'horizontal',
	  items: [{ name: 'One', url: 'home.html', submenu: dm }, { name: 'Two', url: 'home.html', submenu: dm }, { name: 'Three', url: 'home.html', submenu: dm }, { name: 'Four', url: 'home.html', submenu: dm }, { name: 'Five', url: 'home.html', submenu: dm }]
	};

	var m6 = {
	  layout: 'vertical',
	  items: [{ name: 'One', url: 'home.html', submenu: rm }, { name: 'Two', url: 'home.html', submenu: rm }, { name: 'Three', url: 'home.html', submenu: rm }, { name: 'Four', url: 'home.html', submenu: rm }, { name: 'Five', url: 'home.html', submenu: rm }]
	};

	var m7 = {
	  layout: 'vertical',
	  position: 'right',
	  items: [{ name: 'One', url: 'home.html', submenu: rm }, { name: 'Two', url: 'home.html', submenu: rm }, { name: 'Three', url: 'home.html', submenu: rm }]
	};

	var m8 = {
	  layout: 'vertical',
	  items: [{ name: 'One', url: 'home.html', submenu: m7 }, { name: 'Two', url: 'home.html', submenu: m7 }, { name: 'Three', url: 'home.html', submenu: m7 }]
	};
	...
	_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_menu2.default, { config: m6, expandOnHover: true })
	  ),
	  _react2.default.createElement(
	    'p',
	    null,
	  ...
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_menu2.default, { config: m5, expandOnHover: true })
	  ),
	  _react2.default.createElement(
	    'p',
	    null,
	  ...
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_menu2.default, { config: m1, expandOnHover: true })
	  ),
	  _react2.default.createElement(
	    'p',
	    null,
	  ...
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_menu2.default, { config: m2, expandOnHover: true })
	  ),
	  _react2.default.createElement(
	    'p',
	    null,
	  ...
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_menu2.default, { config: m3, expandOnHover: true })
	  ),
	  _react2.default.createElement(
	    'p',
	    null,
	    'Submenu on the bottom:'
	  ),
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_menu2.default, { config: m4, expandOnHover: true })
	  ),
	  _react2.default.createElement(
	    'p',
	    null,
	  ...
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_menu2.default, { config: m8, expandOnHover: true, level: 0 })
	  ),
	  _react2.default.createElement(
	    'p',
	    null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _menuitem = __webpack_require__(161);
	...
	var Menu = function (_Component) {
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function getPositionStyle(level, position, width, height, parentWidth, parentHeight) {
	      if (level == 0) return {};
	      switch (position) {
	        case 'top':
	          return {
	    ...
	    key: 'getStyle',
	    value: function getStyle(level, position, width, height, parentWidth, parentHeight) {
	      var style = {
	      ...
	      return Object.assign(style, this.getPositionStyle(level, position, width, height, parentWidth, parentHeight));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var parentWidth = _props.parentWidth;
	      var parentHeight = _props.parentHeight;
	      var dposition = _props.dposition;
	      var _config$items = config.items;
	      var items = _config$items === undefined ? [] : _config$items;
	      var _config$layout = config.layout;
	      var layout = _config$layout === undefined ? 'vertical' : _config$layout;
	      var _config$position = config.position;
	      var position = _config$position === undefined ? dposition : _config$position;
	      ...
	      var style = this.getStyle(level, position, width, height, parentWidth, parentHeight);
	      return _react2.default.createElement(
	        'div',
	        { style: style, ref: 'menu' },
	        menuItems
	      );
	    }
	  }]);
	...
	var MenuItem = function (_Component) {
	  ...
	  _createClass(MenuItem, [{
	    ...
	    value: function setActive(active) {
	      var expandOnHover = this.props.expandOnHover;

	      var newState = { highlighted: active };
	      if (expandOnHover) {
	    ...
	    key: 'getStyle',
	    value: function getStyle(highlighted, layout, level, expand) {
	      return {
	        position: 'relative',
	    ...
	    value: function render() {
	      ...
	      var dposition = _props2.dposition;
	      var _state = this.state;
	      var highlighted = _state.highlighted;
	      var expand = _state.expand;
	      var width = _state.width;
	      var height = _state.height;
	      ...
	      return _react2.default.createElement(
	        ...
	        expand && submenu ? _react2.default.createElement(_menu2.default, {
	          config: submenu,
	          level: level + 2,
	          parentWidth: width,
	          parentHeight: height,
	        ...
	        _react2.default.createElement(_button2.default, { text: name, highlighted: highlighted, level: level + 1 })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var linear = { items: [{ name: 'red' }, { name: 'black' }, { name: 'linear gray' }] };
	var tactile = { items: [{ name: 'brown' }, { name: 'clear' }, { name: 'tactile gray' }] };
	var clicky = { items: [{ name: 'blue' }, { name: 'green' }, { name: 'white' }] };

	var switch_types = {
	  layout: 'horizontal',
	  items: [{ name: 'linear', submenu: linear }, { name: 'tactile', submenu: tactile }, { name: 'clicky', submenu: clicky }]
	};

	var configs = ['bottom', 'left', 'right', 'top'].map(function (pos) {
	  return Object.assign({}, switch_types, { dposition: pos });
	});

	var menus = configs.map(function (config, index) {
	  return _react2.default.createElement(
	    'div',
	    null,
	...
	var numbers5 = {
	  layout: 'vertical',
	  dposition: 'right',
	  items: [{ name: 'One', submenu: numbers3 }, { name: 'Two', submenu: numbers3 }, { name: 'Three', submenu: numbers3 }, { name: 'Four', submenu: numbers3 }, { name: 'Five', submenu: numbers3 }]
	};

	var nested = {
	  items: [{ name: 'One', submenu: numbers5 }, { name: 'Two', submenu: numbers5 }, { name: 'Three', submenu: numbers5 }, { name: 'Four', submenu: numbers5 }, { name: 'Five', submenu: numbers5 }]
	};

	var titleStyle = { lineHeight: 4 };
